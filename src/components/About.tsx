...
const About = () => {
  ...
  return (
    <section id="about" ref={ref}
      className={`py-16 bg-gray-800 transition-opacity duration-1000 ${inView ? 'opacity-100' : 'opacity-0'
        }`}>
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-white mb-12">Why Choose Us?</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit) => (
            <div key={benefit} className="p-6 rounded-lg bg-gray-700 text-center transform hover:scale-105 transition-transform">
